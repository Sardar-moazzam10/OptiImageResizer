...
export const APP_CONFIG = {
  ...
  version: '1.0.0',
  siteUrl: process.env.NEXT_PUBLIC_SITE_URL || 'https://optisizer.com',
...
export const FEATURES = [
  {
    ...
    description: 'Experience crystal-clear image quality with our advanced resizing algorithms. No compromise on quality.',
    icon: 'Sparkles',
    color: 'primary'
  },
  {
    ...
    description: 'Perfect your images for any platform with our smart presets. Instagram, Facebook, Twitter - we\'ve got you covered.',
    icon: 'Zap',
    color: 'yellow'
  },
  {
    ...
    description: 'Take command of every pixel with our intuitive controls. Perfect dimensions, perfect results.',
    icon: 'Shield',
    color: 'green'
  }
] as const;
...
export const ERROR_MESSAGES = {
  fileTooLarge: `File size must be less than ${APP_CONFIG.maxFileSize / (1024 * 1024)}MB`,
